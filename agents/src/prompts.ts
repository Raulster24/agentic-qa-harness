...
## Known quirk of the app under test
It is a single-page application: the snapshot returned immediately after a navigation or click can be empty or stale. If that happens, call browser_wait_for (a few seconds or for expected text), then browser_snapshot, before concluding anything about the page.
...
export const SUBMIT_SPEC_TOOL: ChatCompletionTool = {
  type: "function",
  function: {
    name: "submit_spec",
